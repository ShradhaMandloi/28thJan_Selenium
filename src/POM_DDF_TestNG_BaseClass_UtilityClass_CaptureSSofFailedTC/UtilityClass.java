...
public class UtilityClass {
	...
	File dest=new File("C:\\Users\\DC\\Desktop\\screenshot\\TestcaseID"+TCID+".jpg");
	FileHandler.copy(src, dest);
	
	
	}
	public static String getPropertyFileData(String key) throws IOException {
		FileInputStream file=new FileInputStream("C:\\Users\\DC\\eclipse-workspace\\28jan eve sel project\\PropertyFile.properties");
